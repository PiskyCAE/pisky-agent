...
function start(token, agentCtx) {
  ...
  bot.command('start', ctx => {
    ...
    ctx.reply(
      '*pisky\\-agent online*\n\n' +
      'I have a real Solana wallet, execute real trades on Jupiter, and coordinate with a swarm of peer agents\\.\n\n' +
  ...
  bot.start({
    onStart: info => log('info', `Telegram bot started: @${info.username}`),
